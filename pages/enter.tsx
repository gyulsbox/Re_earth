...
function setClassName(...classnames: string[]) {
        ...
        <div className='mt-6'>
          <div className='relative'>
            ...
            <div className='relative -top-3 text-center'>
              <span className='bg-white px-2 text-sm text-gray-500'>Or sign with</span>
            </div>
          </div>
