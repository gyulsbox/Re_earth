        ...
        <div className="flex items-center mt-4 pb-4 space-x-3 border-b-2">
          {user?.avatar ? (
            <img
              ...
              src={`https://imagedelivery.net/w46l_DmHQSMJLI8NrmR8QQ/${user?.avatar}/avatar`}
            />
          ) : (
        ...
        <div className="mt-6 flex justify-around">
          <Link href="/profile/sold">
            <a className="flex flex-col items-center">
              <div className="w-14 h-14 text-white bg-lime-400 rounded-full flex items-center justify-center">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
